...
public interface FooPersistence extends BasePersistence<Foo> {
	 ...
	 * @return the matching foos
	 */
	public java.util.List<Foo> findByfooName(String fooName);
	 ...
	 * @return the range of matching foos
	 */
	public java.util.List<Foo> findByfooName(
	 ...
	 * @return the matching foos
	 */
	public java.util.List<Foo> findByfooAge(int fooAge);
	 ...
	 * @return the range of matching foos
	 */
	public java.util.List<Foo> findByfooAge(int fooAge, int start, int end);
	 ...
	 * @return the ordered range of matching foos
	 */
	public java.util.List<Foo> findByfooAge(
